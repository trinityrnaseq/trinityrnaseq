...
echo BE SURE TO: reuse GridEngine-Broad

../../Trinity --left top100k.Left.fq --right top100k.Right.fq --jaccard_clip --genome top100k.genome --genome_guided_max_intron 1000 --genome_guided_use_bam SP2.chr.bam --JM 1G --seqType fq --grid_conf ../../htc_conf/BroadInst_SGE.test.conf
